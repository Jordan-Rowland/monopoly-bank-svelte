    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "select-player svelte-4wrduw");
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(/*message*/ ctx[0]);
    			attr_dev(div, "class", "tooltip svelte-1vb17tq");
