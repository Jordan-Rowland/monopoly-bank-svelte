...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-1txdik8");
    			...
    			attr_dev(button2, "class", "cancel-button svelte-1txdik8");
    			add_location(button2, file$1, 63, 4, 1358);
    			attr_dev(section, "class", "svelte-1txdik8");
    			add_location(section, file$1, 34, 2, 730);
    			attr_dev(div, "class", "container svelte-1txdik8");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 24, 4, 488);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "name", "confirm");
    			add_location(input, file$2, 27, 4, 521);
    			add_location(button, file$2, 28, 4, 580);
    			attr_dev(div0, "class", "card svelte-1lgovja");
    			add_location(div0, file$2, 23, 2, 465);
    			attr_dev(div1, "class", "container");
    			add_location(div1, file$2, 22, 0, 439);

    			dispose = [
    				listen_dev(input, "input", /*input_input_handler*/ ctx[5]),
    				listen_dev(button, "click", /*confirmBankrupt*/ ctx[2], false, false, false)
    			];
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*verify*/ ctx[1]);
    			append_dev(div0, t3);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*verify*/ 2 && input.value !== /*verify*/ ctx[1]) {
    				set_input_value(input, /*verify*/ ctx[1]);
    			}
    		},
    		i: function intro(local) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	const dispatch = createEventDispatcher();
    	let { message = "To declare bankruptcy, type 'BANKRUPT' in the field below" } = $$props;
    	let verify;
    	...
    	$$self.$inject_state = $$props => {
    		if ("message" in $$props) $$invalidate(0, message = $$props.message);
    		if ("verify" in $$props) $$invalidate(1, verify = $$props.verify);
    	};

    	return [message, verify, confirmBankrupt, closeModal, dispatch, input_input_handler];
    }
    ...
    function create_if_block$1(ctx) {
    	let current;
    	const confirmbankrupt = new ConfirmBankrupt({ $$inline: true });
